...
class AppConfig:
    ...
    auto_reboot_overheat_hourly: bool = False   # reboot on schedule while any board stays overheated
    auto_reboot_overheat_minutes: int = 30      # how long a board must overheat before restart fires
